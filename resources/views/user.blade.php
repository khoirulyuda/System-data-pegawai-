            ...
            <div class="col-10">
                <main>
                    ...
                    <div class="profile">
                        ...
                        <small class="text-muted mt-2px"></small>
                        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="/rgst" class="btn btn-success">Tambah +</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a
                                                href="#"
                                                class="btn btn-danger delete" data-id="{{ $row->id }}" data-nama="{{ $row->name }}"
                                            >
                                                Delete
                                            </a>
                                        </td>
