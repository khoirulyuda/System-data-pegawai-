                    ...
                    <div class="col">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-header">
                                    ...
                                    <form action="/importpibdocument" method="POST" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <table class="table">
                                <thead>
                                    ...
                                    <th scope="col">DokKd</th>
                                    <th scope="col">DokNo</th>
                                    <th scope="col">DokTg</th>
                                    <th scope="col">KdGroupDok</th>
  ...
  <script>
    $('.delete').click(function(){
        ...
        swal({
                    ...
                    .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletepibdok/"+pegawaiid+" "
