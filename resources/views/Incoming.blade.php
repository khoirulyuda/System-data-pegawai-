                    ...
                    <div class="col">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-header">
                                    ...
                                    <form action="/importincoming" method="POST" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <table class="table">
                                <thead>
                                    ...
                                    <th scope="col">Mat Enter Date</th>
                                    <th scope="col">Qty</th>
                                    <th scope="col">Weight</th>
                                    <th scope="col">Store / Flag</th>
                                    <th scope="col">RDM No</th>
                                ...
                                <tbody>
                                    @php $no=1; @endphp @foreach ($data as $Incoming => $row )
                                    <tr>
                                        <th scope="row">{{ $Incoming + $data -> firstItem() }}</th>
                                        <td>
                                            <a
