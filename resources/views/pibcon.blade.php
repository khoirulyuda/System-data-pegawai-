                ...
                <main>
                    ...
                    <div class="col">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="/pibconexcel" class="btn btn-success">Export Excel</a>
                            </div>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-header">
                                    ...
                                    <form action="/importpibcontainer" method="POST" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <table class="table">
                                <thead>
                                    ...
                                    <th scope="col">ContUkur</th>
                                    
                                    </tr>
                                </thead>
                                <tbody>
                                    @php $no=1; @endphp @foreach ($data as $Pibcontainer => $row )
                                    <tr>
                                        <th scope="row">{{ $Pibcontainer + $data -> firstItem() }}</th>
                                        <td>
                                            <a
  ...
  <script>
    $('.delete').click(function(){
        ...
        swal({
                    ...
                    .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletepibcontainer/"+pegawaiid+" "
