              ...
              @csrf
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" name="role" aria-label="Default select example">
                    ...
                    <option value="adminsales">Leader Sales</option>
                    <option value="adminsales">Supervisor Sales</option>
                    <option value="adminsales">Admin Production</option>
                    <option value="adminsales">Leader Production</option>
                    <option value="adminsales">Supervisor Production</option>
                    <option value="adminsales">Admin Exim</option>
                    <option value="adminsales">Leader Exim</option>
                    <option value="adminsales">Supervisor Exim</option>
                    <option value="adminsales">Admin Outgoing</option>
                    <option value="adminsales">Leader Outgoing</option>
                    <option value="adminsales">Supervisor Outgoing</option>
